			...
			<!-- start: Content -->
				...
				<div class="box span12">
					<div class="box-header">
						...
						<div class="box-icon">
							{if $showFlag eq 'true'}
							<img class="icon-flag" lang="ch" url="{$baseUrl}company/setLanguage" data-cfstyle="width:30px" data-cfsrc="{$baseUrl}assets/img/flag-{$locale}.png" style="width:30px" src="{$baseUrl}assets/img/flag-{$locale}.png">
							<img class="icon-flag" lang="en" url="{$baseUrl}company/setLanguage" data-cfstyle="width:30px" data-cfsrc="{$baseUrl}assets/img/flag-us.png" style="width:30px" src="{$baseUrl}assets/img/flag-us.png">
							{/if}
