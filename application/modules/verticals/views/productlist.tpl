						...
						<table class="table table-striped table-bordered">
								<tr>
									<td>Search By:
										...
										<a href="{$baseUrl}verticals/productlist/zh"><div class="chinese-flag"></div></a>
										<a href="{$baseUrl}verticals/productlist/en"><div class="english-flag"></div></a>
						...
						<table class="table table-striped table-bordered bootstrap-datatable" id="datable-prodlist">
						  ...
						  <tbody>
							...
							{foreach from=$productList item=product}
								...
								{/if}
							<tr>
								<td><center><img src="{$product->product_icon}" width="30"></center></td>
								<td width="20%">{$product->product_name}</td>
								<td width="10%">{$product->product_type}</td>
								<td width="20%">{$product->company_name}</td>
								<td width="10%">{$product->area_name}</td>
