...
<head>
	...
	<link href="{$baseUrl}assets/css/datepicker.css" rel="stylesheet">
	<!-- <link href="{$baseUrl}assets/css/adapted_guides.css" type="text/css" rel="stylesheet">-->
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{$baseUrl}dashboard/members_area"><span class="hidden-phone"><img src="{$baseUrl}assets/img/logo_{$logo}.png" style="max-width:25%" ></span></a>
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li>
							...
							<ul>
                           	...
                           	<li><a class="submenu" href="{$baseUrl}leads/leadsearchlist"><span class="hidden-tablet"> Leads Search</span></a></li>
                           	<li><a class="submenu" href="{$baseUrl}leads/leadstat"><span class="hidden-tablet"> Leads Stats</span></a></li>
