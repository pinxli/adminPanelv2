$(document).ready(function(){
	...
	$('#selectError3').change(function(){
		...
		$.ajax({ 
		   ...
		   success: function(resultData){ 
			   ...
			   var vertical = resultData.verticaltype;
		  
			   if(vertical == 'credit-card')
			   {
					var appendElements = '<div class="control-group product_options"><hr>';
					appendElements += '<div class="row-fluid">';
					appendElements += '<div class="span5">';
					appendElements += '<div class="row-fluid clearfix">';
					appendElements += '<div class="span5 resultsCellInner found_company">';
					appendElements += '<div class="logoAndIcons">';
					appendElements += '<img border="0" class="img_product" alt="" data-ng-src="" src="http://admindev.compargo.com/assets/img/displaycc_ph.png">';
					appendElements += '</div>';
					appendElements += '</div>';
					appendElements += '<div class="span7 resultsCellInner found_feature">';
					
					//Product Name
					appendElements += '<div class="clearfix">';
					appendElements += '<h2 class="ng-binding product_name" id="product_name">Product Name</h2>';
					appendElements += '</div>';
					
					//Key Benefits
					appendElements += '<ul class="unstyled">';
					appendElements += '<li><span class="keyBenefit1" id="keyBenefit1" origVal="keyBenefit1">keyBenefit1</span></li>';
					appendElements += '<li><span class="keyBenefit2" id="keyBenefit2" origVal="keyBenefit2">keyBenefit2</span></li>';
					appendElements += '<li><span class="keyBenefit3" id="keyBenefit3" origVal="keyBenefit3">keyBenefit3</span></li>';
					appendElements += '</ul>';
					...
					appendElements += '<div class="span7 other_dtl_cc">';
					appendElements += '<div class="row-fluid clearfix">';
					appendElements += '<div id="pop1" role="dialog" tabindex="-1" class="span5 text-center text_rewards dtl fix_me">';
					
					//Cash Back Rewards Special
					appendElements += '<span class="icon-money"></span>';
					appendElements += '<span class="txt cashbackrewardspecial" id="cashBackRewardsSpecial" origval="cashBackRewardsSpecial">cashBackRewardsSpecial</span>';
					appendElements += '<br>';
					
					//Miles Rewards Enrich Miles
					appendElements += '<span class="icon-plane"></span>';
					appendElements += '<span class="txt milesRewardsEnrichMiles" id="milesRewardsEnrichMiles" origval="milesRewardsEnrichMiles">milesRewardsEnrichMiles HKD Per Mile</span>';
					appendElements += '<br>';
					
					appendElements += '<span class="icon-barcode"></span>';
					appendElements += '<span class="txt">3% Cash Rebate on Overseas and Online Spending</span>';
					appendElements += '<br>';
					appendElements += '</div>';
					
					//Currency and Annual Fee
					appendElements += '<div class="span2 text-center dtl">';
					appendElements += '<em class="ng-binding">';
					appendElements += '<span class="currency" id="currency" origval="currency">currency</span>';
					appendElements += '<span class="AnualFee" id="annualFee" origval="AnualFee">AnualFee</span>';
					appendElements += '</em>';
					appendElements += '<p class="">$ per year</p>';
					appendElements += '</div>';
					
					//Interest Rate
					appendElements += '<div class="span2 text-center dtl">';
					appendElements += '<em class="ng-binding interestrate">';
					appendElements += '<span class="InterestRate" id="interestRate" origVal="InterestRate">InterestRate</span>';
					appendElements += '</em>';
					appendElements += '<p class="py">per year</p>';
					appendElements += '</div>';
					appendElements += '</div>';
					appendElements += '</div>';
					appendElements += '</div>';
					appendElements += '<div><hr></div>';
					appendElements += '</div>';
					
					$('#category_type').append(appendElements);					
					
				   // $('#category_type').append('<div class="control-group product_options"><hr><div class="row-fluid"><div class="span5"><div class="row-fluid clearfix"><div class="span5 resultsCellInner found_company"><div class="logoAndIcons"><img border="0" class="img_product" alt="" data-ng-src="http://localhost/frontpage/assets/img/creditcards/ocbc-gold-visa.jpg" src="http://localhost/frontpage/assets/img/creditcards/ocbc-gold-visa.jpg"></div></div><div class="span7 resultsCellInner found_feature"><div class="clearfix"><h2 class="ng-binding product_name" id="product_name">{Product Name}</h2></div><ul class="unstyled"><li><span class="keyBenefit1" id="keyBenefit1" origVal="{keyBenefit1}">{keyBenefit1}</span></li><li><span class="keyBenefit2" id="keyBenefit2" origVal="{keyBenefit2}">{keyBenefit2}</span></li><li><span class="keyBenefit3" id="keyBenefit3" origVal="{keyBenefit3}">{keyBenefit3}</span></li></ul></div></div></div><div class="span7 other_dtl_cc"><div class="row-fluid clearfix">'+
						   // '<div id="pop1" role="dialog" tabindex="-1" class="span5 text-center text_rewards dtl fix_me">' +
						   // '<span class="icon-money"></span><span class="txt cashbackrewardspecial" id="cashBackRewardsSpecial">{cashBackRewardsSpecial}</span><br>'+			    
						   // '<span class="icon-plane"></span><span class="txt milesRewardsEnrichMiles">{milesRewardsEnrichMiles} HKD Per Mile</span><br>'+
						   // '<span class="icon-barcode"></span><span class="txt">3% Cash Rebate on Overseas and Online Spending</span><br>'+
						   // '</div><div class="span2 text-center dtl"><em class="ng-binding"><span id="currency" class="currency" origval="{currency}">{currency}</span> <span id="AnualFee" class="AnualFee" origval="{AnualFee}">{AnualFee}</span></em><p class="">$ per year</p></div><div class="span2 text-center dtl"><em class="ng-binding interestrate">{InterestRate}</em><p class="py">per year</p></div></div></div></div></div><div> <hr></div>');
			   }
			    ...
			    $.each(result, function(k,v){
					...
					else
					{
							...
							var appendOption = '<div class="control-group product_options">';
							appendOption += '<label class="control-label" for="focusedInput">' +v.option_key +':</label>';
							appendOption += '<div class="controls">';
							appendOption += '<input type="text" alt= "'+v.option_key +'" title="'+v.option_key +'" name="option['+optionkey +'-' + v.id+ ']" value="" class="input-xlarge focused" id="inp_'+v.option_key +'" onkeyup="productAdd(this.title,this.alt)" placeholder="' +v.option_key +' Value"> &nbsp; ';
							appendOption += 'Expiry Days:<input class="input-small focused autonum" type="number" name="expiry_date['+ v.id +']" min="1" max="30" onclick="checknumeric()">';
							appendOption += '</div>';
							appendOption += '</div>';
							
						$('#uploadimage').after(appendOption);
							
						// $('#uploadimage').after('<div class="control-group product_options"><label class="control-label" for="focusedInput">' +v.option_key +':</label><div class="controls"><input type="text" alt= "'+v.option_key +'" title="'+v.option_key +'" name="option['+optionkey +'-' + v.id+ ']" value="" class="input-xlarge focused productAdd" id="inp_'+v.option_key +'" onkeyup="productAdd(this.title,this.alt)" placeholder="' +v.option_key +' Value"> &nbsp; Expiry Days:<input class="input-small focused autonum" type="number" name="expiry_date['+ v.id +']" min="1" max="30" onclick="checknumeric()"></div></div>');
					}
	...
	$('.btn-cancel').click(function(){
		window.location.replace( $(this).attr('alt') );
	});
	
	//option edit
	$('.optionedit').click(function(){
		var optionId 	= $(this).attr('id');
		var option 		= $(this).attr('alt').split(":");
		var optionKey	= option[0];
		var optionValue	= option[1];
		
		var row = '<input type="text" class="input-xlarge" name="options['+optionId+']" value="'+optionValue+'" />';
		// row += '&nbsp;<a class="btn btn-info done">';
		// row += '<i class="fa fa-check-circle icon-white" alt="'+optionId+'" title="Done"></i></a>';
		// row += '<a class="btn btn-danger">';
		// row += '<i class=" icon-white">Cancel</i></a>';
		
		$('#optionvalue'+optionId).html(row);
	});
	
	$('.done').click(function(){
		var optionId = $(this).attr('alt');
		var inputHidden = '<input type="hidden" name="OPTION" value="'+optionId+':'+optionValue+'" />';
		alert(inputHidden);
		$('#myform').append(inputHidden);
	});
...
function deleteProd(url,id)
{
	if ( confirm('Are you sure you want to delete this product?') ){
		window.location.replace( url+'verticals/deleteproduct/'+id );
	}
...
function productAdd(title,alt)
{
	var origVal = $('#'+alt).attr('origval');
	var value 	= $('#inp_'+alt).val();
	console.log(title+' - '+alt+' - '+origVal);
...
function deleteUser(url,id)
{
	if ( confirm('Are you sure you want to delete this user?') ){
		window.location.replace( url+'settings/user_delete/'+id );
	}
}
...
function verticalType(){
	...
	$.ajax({ 
		   ...
		   url: url + str,
		   success: function(resultData){ 
			   console.log("{$verticalTypeUrl}" + str + resultData);       
			   var result = resultData.data.verticaloptioninfo;
			    $.each(result, function(k,v){
...
function charts() {
	...
	if($("#stats-chart").length)
	{
		...
		// alert( $('#chartStat').val() );
		// var leads = $.parseJSON( $('#leadStat').val() );
		// var visitors = $.parseJSON( $('#visitStat').val() );
		
		// var leads 	 = [[1, leads[0]], [2, leads[1]], [3, leads[2]], [4, leads[3]], [5, leads[4]], [6, leads[5]], [7, leads[6]]];
		// var visitors = [[1, visitors[0]], [2, visitors[1]], [3, visitors[2]], [4, visitors[3]], [5, visitors[4]], [6, visitors[5]], [7, visitors[6]]];

		var plot = $.plot($("#stats-chart"),
			   [ { data: leads, label: "Leads" }, { data: visitors, label: "Visitors" } ], {
				   series: {
					   lines: { show: true,
								lineWidth: 3,
